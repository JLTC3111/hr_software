...
export const MiniFlubberAutoMorphTotalTasks = ({
  ...
  className = '',
  isDarkMode = false,
  autoMorphInterval = 1000, // Time between auto-morphs in ms
  morphDuration = 500, // Duration of each morph animation
}) => {
...
export const MiniFlubberAutoMorphQuality = ({
  size = 24,
  className = '',
  isDarkMode = false,
  autoMorphInterval = 1000, // Time between auto-morphs in ms
  ...
  /** Icon definitions */
  const icons = [
    { name: 'Badge', Icon: BadgeCheck, status: 'stanard' },
    { name: 'Star', Icon: Star, status: 'standard' },
    { name: 'Medal', Icon: Medal, status: 'standard' },
    { name: 'Award', Icon: Award, status: 'standard' },
    { name: 'Trophy', Icon: Trophy, status: 'standard' },
  ];
...
export const MiniFlubberAutoMorphCompletedWork = ({
  size = 24,
  className = '',
  isDarkMode = false,
  autoMorphInterval = 1000, // Time between auto-morphs in ms
  ...
  /** Icon definitions */
  const icons = [
    { name: 'Shiled', Icon: ShieldCheck, status: 'stanard' },
    { name: 'Check', Icon: CheckCheck, status: 'standard' },
    { name: 'Circle', Icon: CircleCheckBig, status: 'standard' },
    { name: 'Cloud', Icon: CloudCheck, status: 'standard' },
    { name: 'Monitor', Icon: MonitorCheck, status: 'standard' },
  ];
...
export const MiniFlubberAutoMorphOverdueTasks = ({
  size = 24,
  className = '',
  isDarkMode = false,
  autoMorphInterval = 1000, // Time between auto-morphs in ms
  ...
  /** Icon definitions */
  const icons = [
    { name: 'Alert', Icon: AlertCircle, status: 'standard' },
    { name: 'Calendar', Icon: CalendarOff, status: 'standard' },
    { name: 'Bell', Icon: BellMinus, status: 'standard' },
    { name: 'Timer', Icon: TimerOff, status: 'standard' },
    { name: 'CalendarX', Icon: CalendarX, status: 'standard' },
  ];
