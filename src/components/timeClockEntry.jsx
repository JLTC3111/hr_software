          ...
          <div className={`${bg.secondary} rounded-lg shadow-lg p-6 ${border.primary}`}>
            ...
            >
                {isSubmitting ? (
                    ...
                    // Show the Clock icon when static
                    <>
            ...
            <div className={`mt-4 pt-4 border-t ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
              <button
                ...
                className="w-full group py-3 px-6 rounded-lg font-medium cursor-pointer text-white bg-green-700 hover:bg-green-800 active:scale-[0.98] transition-all flex items-center justify-center space-x-2"
              >
