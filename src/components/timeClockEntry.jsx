...
const ClockIcon = ({ className, isDarkMode }) => {
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  `}
                />
                <ClockIcon className={`absolute top-1/2 right-3 transform -translate-y-1/2 pointer-events-none w-6 h-6 ${text.secondary}`} isDarkMode={isDarkMode} />
              </div>
