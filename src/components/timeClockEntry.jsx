...
// Animated Clock 1 (uses currentColor so CSS color classes apply)
export const AnimatedAlarmClockIcon = ({ className, isDarkMode }) => {
  ...
  // Provide default CSS color (used when no CSS color is applied via classes)
  ...
  return (
    <svg 
      ...
      style={{ color: defaultColor, transition: 'color 160ms ease' }}
    >
      {/* 1. Clock Body (Static) */}
      <path 
        d={clockBodyPath} 
