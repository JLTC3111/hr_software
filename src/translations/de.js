export default {
  ...
  nav: {
    ...
    translations: 'Übersetzungsstudio',
  ...
  leave: {
    ...
    requestsTitle: 'Urlaubsanträge',
    noRequests: 'Noch keine Urlaubsanträge.',
    everyone: 'Alle',
    mine: 'Mein Urlaub',
    today: 'Heute',
    ...
    selectDatesFirst: 'Klicken Sie zuerst auf ein Start- und Enddatum im Kalender.',
    selectedDates: 'Ausgewählte Daten',
    adjustOnCalendar: 'Schließen Sie diesen Dialog, um die Daten im Kalender neu auszuwählen.',
    invalidRange: 'Das Enddatum darf nicht vor dem Startdatum liegen.',
    selectEmployee: 'Bitte wählen Sie einen Mitarbeiter aus.',
    type: 'Typ',
    allTypes: 'Alle Typen',
    ...
    days: 'Tage',
    halfDay: 'Halber Tag',
    halfDayTag: '[Halber Tag]',
    startTime: 'Startzeit',
    endTime: 'Endzeit',
    reason: 'Grund',
    reasonPlaceholder: 'Fügen Sie eine optionale Notiz für Ihren Vorgesetzten hinzu...',
    ...
    rejectReasonPrompt: 'Grund für die Ablehnung dieses Antrags (optional):',
    approve: 'Genehmigen',
    reject: 'Ablehnen',
    other: 'Sonstiges',
    ...
    filtersTitle: 'Filter & Legende',
    statusFilter: 'Status',
    allStatuses: 'Alle',
    legendTitle: 'Legende',
    addForEmployee: 'Für Mitarbeiter hinzufügen',
    addLeaveForEmployee: 'Urlaub für Mitarbeiter hinzufügen',
    autoApprove: 'Sofort genehmigen',
    autoApproveHint: 'Warteschlange überspringen und als genehmigt markieren.',
    submitAndApprove: 'Einreichen & Genehmigen',
    submitAndApproved: 'Urlaub hinzugefügt und genehmigt.',
    manualDates: 'Start- und Enddatum eingeben.',
    onBehalfNote: 'Sie reichen Urlaub im Namen dieses Mitarbeiters ein.',
    rejectTitle: 'Urlaubsantrag ablehnen',
  ...
  header: {
    ...
    welcomePhrase1: 'Willkommen zurück, {name}',
    welcomePhrase2: 'Schön, Sie zu sehen, {name}',
    welcomePhrase3: 'Hallo, {name}!',
    welcomePhrase4: 'Bereit für HR-Management, {name}?',
    welcomePhrase5: 'Lassen Sie uns produktiv sein, {name}',
    welcomePhrase6: 'Schön, dass Sie da sind, {name}',
    user: 'HR-Team',
    logout: 'Abmelden'
  },
  ...
  reports: {
    ...
    excel: {
      ...
      summaryTitle: 'HR-Bericht Zusammenfassung',
      generated: 'Erstellt am',
      dateRange: 'Zeitraum',
      employee: 'Mitarbeiter',
      reportLanguage: 'Berichtssprache',
      visual: 'Visuell',
      timeTracking: 'Zeitpfassung Zusammenfassung',
      workload: 'Arbeitsbelastung Zusammenfassung',
      goals: 'Ziele Zusammenfassung',
      metrics: {
        totalTimeEntries: 'Gesamt Zeiteinträge',
        totalHours: 'Gesamtstunden protokolliert',
        regularHours: 'Reguläre Stunden',
        overtimeHours: 'Überstunden',
        wfhHours: 'Home-Office Stunden',
        pendingApprovals: 'Ausstehende Genehmigungen',
        approvedEntries: 'Genehmigte Einträge',
        totalTasks: 'Gesamtaufgaben',
        completedTasks: 'Abgeschlossene Aufgaben',
        inProgress: 'In Bearbeitung',
        highPriorityTasks: 'Aufgaben mit hoher Priorität',
        estimatedHours: 'Geschätzte Tage',
        actualHours: 'Tatsächliche Tage',
        variance: 'Abweichung',
      ...
      performance: {
        ...
        approvalRate: 'Genehmigungsquote',
        taskCompletionRate: 'Aufgabenerfüllungsquote',
        avgGoalProgress: 'Durchschn. Zielfortschritt',
        overallRating: 'Gesamtleistungsbewertung',
        overallScore: 'Gesamtleistungspunktzahl:',
  ...
  employeeDetailModal: {
    ...
    documents: 'Dokumente',
    pdfTab: 'PDF',
    requestDocsTab: 'Anträge',
    requestDocsRefresh: 'Aktualisieren',
    requestDocsOpen: 'Öffnen',
    requestDocsPreview: 'Vorschau',
    requestDocsDelete: 'Löschen',
    requestDocsOpenInNewTab: 'In neuem Tab öffnen',
    requestDocsClosePreview: 'Vorschau schließen',
    requestDocsLoading: 'Wird geladen...',
    uploadRequestDoc: 'Dokument hochladen',
    docCategory: 'Kategorie',
    categoryLeave: 'Urlaubsantrag',
    categoryOther: 'Andere',
    noRequestDocs: 'Keine Dokumente hochgeladen',
    requestDocsHint: 'Laden Sie Nachweise für Urlaubsanträge, Zertifikate oder andere Dateien hoch.',
    requestDocsRestricted: 'Nur Admin/HR/Manager können Antragsdokumente hochladen.',
    requestDocUploaded: 'Dokument erfolgreich hochgeladen!',
  ...
  taskListing: {
    ...
    dueDate: 'Fälligkeitsdatum',
    startDate: 'Startdatum',
    completionBeforeStart: 'Das Abschlussdatum darf nicht vor dem Startdatum liegen',
  ...
  controlPanel: {
    ...
    role: 'Rolle',
    switchToPrefix: 'Wechseln zu',
    demoAdminLabel: 'Demo-Administrator',
    demoEmployeeLabel: 'Demo-Mitarbeiter',
    ...
    visit: {
      ...
      noVisits: 'Noch keine Besuche protokolliert.',
      unknownIp: 'unbekannte IP',
      ref: 'Ref',
      refDesc: 'Verweis-URL, die den Besuch ausgelöst hat',
      userAgent: 'User-Agent',
      userAgentDesc: 'Browser- und Betriebssysteminformationen des Besuchers',
      lastVisit: 'Letzter Besuch',
      lastVisitDesc: 'Zeitstempel des letzten Besuchs dieses Benutzers',
      visits: 'Besuche',
  ...
  translationStudio: {
    ...
    suggestHint: 'Füllt nur leere Felder. Nichts wird gespeichert, bevor Sie es geprüft haben.',
    suggested: 'Vorschläge eingefügt',
    needsDownload: 'Ein Vorschlag für diese Sprache lädt zuerst ein Modell herunter',
    notConfigured: 'Die Übersetzungstabelle fehlt. Wenden Sie die Migration 018_hr_ugc_translations.sql an (supabase db push), um das Speichern zu aktivieren.',
    ...
    sourceLeave: 'Urlaubsanträge',
    status: 'Status',
    filter_all: 'Alle',
    filter_untranslated: 'Nicht übersetzt',
    filter_translated: 'Vollständig',
    filter_stale: 'Veraltet',
    searchPlaceholder: 'Text, Datensatz oder Mitarbeiter suchen',
    empty: 'Nichts entspricht diesen Filtern.',
    loadError: 'Übersetzbare Inhalte konnten nicht geladen werden.',
    selectPrompt: 'Wählen Sie links einen Text zum Übersetzen aus.',
    saved: 'Gespeichert',
    removed: 'Entfernt',
    saveError: 'Speichern fehlgeschlagen',
    stale: 'Quelle geändert',
    machineDraft: 'Maschineller Entwurf',
    remove: 'Entfernen',
    draftUnavailable: 'Für diese Sprache ist noch kein lokales Modell vorhanden.',
    noLocalModel: 'Dieser Browser hat keinen lokalen Übersetzer, daher sind maschinelle Entwürfe nicht verfügbar. Sie können Übersetzungen weiterhin von Hand schreiben.',
    demoUnavailable: 'Übersetzungen werden auf dem Server gespeichert und sind im Demomodus nicht verfügbar.',
    field_title: 'Titel',
    field_description: 'Beschreibung',
    field_self_assessment: 'Selbsteinschätzung',
    field_comments: 'Kommentare',
    field_notes: 'Notizen',
    field_success_criteria: 'Erfolgskriterien',
    field_strengths: 'Stärken',
    field_areas_for_improvement: 'Verbesserungsbereiche',
    field_achievements: 'Erfolge',
    field_employee_comments: 'Mitarbeiterkommentare',
    field_reason: 'Grund',
    field_rejection_reason: 'Ablehnungsgrund',
  },
};
