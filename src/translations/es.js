export default {
  nav: {
    ...
    translations: 'Estudio de traducción',
  ...
  // Leave Management
  leave: {
    subtitle: 'Planifica, solicita y aprueba ausencias en un calendario compartido.',
    requestLeave: 'Solicitar ausencia',
    requestsTitle: 'Solicitudes de ausencia',
    noRequests: 'Aún no hay solicitudes de ausencia.',
    everyone: 'Todos',
    mine: 'Mis ausencias',
    today: 'Hoy',
    ...
    selectDatesFirst: 'Primero haz clic en una fecha de inicio y de fin en el calendario.',
    selectedDates: 'Fechas seleccionadas',
    adjustOnCalendar: 'Cierra este cuadro de diálogo para volver a elegir las fechas en el calendario.',
    invalidRange: 'La fecha de fin no puede ser anterior a la de inicio.',
    ...
    days: 'días',
    halfDay: 'Medio día',
    halfDayTag: '[Medio día]',
    startTime: 'Hora de inicio',
    endTime: 'Hora de fin',
    reason: 'Motivo',
    reasonPlaceholder: 'Añade una nota opcional para tu responsable...',
    submitRequest: 'Enviar solicitud',
    requestSubmitted: '¡Solicitud de ausencia enviada con éxito!',
    requestApproved: 'Solicitud de ausencia aprobada.',
    requestRejected: 'Solicitud de ausencia rechazada.',
    rejectReasonPrompt: 'Motivo para rechazar esta solicitud (opcional):',
    approve: 'Aprobar',
    reject: 'Rechazar',
    other: 'Otro',
    ...
    filtersTitle: 'Filtros y leyenda',
    statusFilter: 'Estado',
    allStatuses: 'Todos',
    legendTitle: 'Leyenda',
    addForEmployee: 'Añadir para empleado',
    addLeaveForEmployee: 'Añadir permiso para empleado',
    autoApprove: 'Aprobar inmediatamente',
    autoApproveHint: 'Omitir la cola pendiente y marcar como aprobado.',
    submitAndApprove: 'Enviar y aprobar',
    submitAndApproved: 'Permiso añadido y aprobado.',
    manualDates: 'Introduzca las fechas de inicio y fin.',
    onBehalfNote: 'Está enviando el permiso en nombre de este empleado.',
    rejectTitle: 'Rechazar solicitud de permiso',
    rejectConfirm: '¿Rechazar permiso de {{name}}?',
    rejectReasonLabel: 'Motivo (opcional)',
    rejectReasonPlaceholder: 'Explique por qué se rechaza esta solicitud...',
  ...
  dashboard: {
    ...
    activities: {
      ...
      performanceReview: 'Revisión de rendimiento completada para: '
    },
    timeAgo: {
      twoHours: 'Hace 2 horas',
      fourHours: 'Hace 4 horas',
  ...
  reports: {
    ...
    excel: {
      ...
      summaryTitle: 'Resumen del Informe de RRHH',
      generated: 'Generado',
      dateRange: 'Rango de Fechas',
      employee: 'Empleado',
      reportLanguage: 'Idioma del Informe',
      visual: 'Visual',
      timeTracking: 'Resumen de Control de Tiempo',
      workload: 'Resumen de Carga de Trabajo',
      goals: 'Resumen de Objetivos',
      metrics: {
        totalTimeEntries: 'Total de Entradas de Tiempo',
        totalHours: 'Total de Horas Registradas',
        regularHours: 'Horas Ordinarias',
        overtimeHours: 'Horas Extra',
        wfhHours: 'Horas de Teletrabajo',
        pendingApprovals: 'Aprobaciones Pendientes',
        ...
        estimatedHours: 'Días estimados',
        actualHours: 'Días reales',
        variance: 'Variación',
      ...
      performance: {
        ...
        avgGoalProgress: 'Progreso Promedio de Objetivos',
        overallRating: 'Calificación de Rendimiento General',
        overallScore: 'Puntuación de Rendimiento General:',
    ...
    summaryOverview: 'Resumen y Descripción General',
    completedTasks: 'Tareas Completadas',
  ...
  employeeDetailModal: {
    ...
    pdfTab: 'PDF',
    requestDocsTab: 'Solicitudes',
    requestDocsRefresh: 'Actualizar',
    requestDocsOpen: 'Abrir',
    requestDocsPreview: 'Vista previa',
    requestDocsDelete: 'Eliminar',
    requestDocsOpenInNewTab: 'Abrir en una nueva pestaña',
    requestDocsClosePreview: 'Cerrar vista previa',
    requestDocsLoading: 'Cargando...',
    uploadRequestDoc: 'Subir documento',
    docCategory: 'Categoría',
    categoryLeave: 'Solicitud de permiso',
    categoryOther: 'Otro',
    noRequestDocs: 'No hay documentos cargados',
    requestDocsHint: 'Sube justificantes de permisos, certificados u otros archivos.',
    requestDocsRestricted: 'Solo Admin/RRHH/Manager pueden subir documentos.',
    requestDocUploaded: '¡Documento subido con éxito!',
    quickStats: 'Estadísticas Rápidas',
    status: 'Estado',
  ...
  taskListing: {
    ...
    dueDate: 'Fecha de vencimiento',
    startDate: 'Fecha de inicio',
    completionBeforeStart: 'La fecha de finalización no puede ser anterior a la fecha de inicio',
  ...
  controlPanel: {
    ...
    demoAdminLabel: 'Administrador de demostración',
    demoEmployeeLabel: 'Empleado de demostración',
    ...
    visit: {
      ...
      noVisits: 'Aún no se han registrado visitas.',
      unknownIp: 'IP desconocida',
      ref: 'Referencia',
      refUnknown: 'Referencia desconocida',
  ...
  demoTasks: {
    'task-1': {
      title: 'Análisis de Informes Q4',
      description: 'Análisis exhaustivo de métricas de rendimiento trimestrales y tendencias - Nota: Estos datos de demostración no se pueden editar. Por favor agregue sus propios datos para realizar pruebas.'
    },
    'task-2': {
      title: 'Actualización del Manual del Empleado',
      description: 'Revisar y actualizar el manual del empleado con políticas de trabajo remoto - Nota: Estos datos de demostración no se pueden editar. Por favor agregue sus propios datos para realizar pruebas.'
    },
    'task-3': {
      title: 'Corrección de Error de Inicio de Sesión',
      description: 'Depurar y resolver problemas de inicio de sesión de usuarios en dispositivos móviles - Nota: Estos datos de demostración no se pueden editar. Por favor agregue sus propios datos para realizar pruebas.'
    },
    'task-4': {
      title: 'Diseñar Nuevo Dashboard',
      description: 'Crear wireframes y mockups para el dashboard de análisis - Nota: Estos datos de demostración no se pueden editar. Por favor agregue sus propios datos para realizar pruebas.'
    },
    'task-5': {
      title: 'Revisión de Rendimiento de Campaña',
      description: 'Analizar resultados y ROI de campañas de marketing Q3 - Nota: Estos datos de demostración no se pueden editar. Por favor agregue sus propios datos para realizar pruebas.'
    },
    'task-6': {
      title: 'Incorporación de Cliente',
      description: 'Completar la incorporación de nuevo cliente empresarial - Nota: Estos datos de demostración no se pueden editar. Por favor agregue sus propios datos para realizar pruebas.'
    },
    'task-7': {
      title: 'Documentación de API',
      description: 'Escribir documentación API completa para la versión 2.0 - Nota: Estos datos de demostración no se pueden editar. Por favor agregue sus propios datos para realizar pruebas.'
    }
  },
  demoGoals: {
    'goal-1': {
      title: 'Mejorar la Eficiencia del Equipo',
      description: 'Aumentar la productividad del equipo en un 20% durante el próximo trimestre - Nota: Estos datos de demostración no se pueden editar. Por favor agregue sus propios datos para realizar pruebas.'
    },
    'goal-2': {
      title: 'Aprender React Native',
      description: 'Dominar React Native para el desarrollo de aplicaciones móviles - Nota: Estos datos de demostración no se pueden editar. Por favor agregue sus propios datos para realizar pruebas.'
    },
    'goal-3': {
      title: 'Certificación UX',
      description: 'Obtener el Certificado Profesional de Diseño UX de Google - Nota: Estos datos de demostración no se pueden editar. Por favor agregue sus propios datos para realizar pruebas.'
    },
    'goal-4': {
      title: 'Aumentar Generación de Leads',
      description: 'Lograr un aumento del 30% en leads cualificados mediante campañas de marketing - Nota: Estos datos de demostración no se pueden editar. Por favor agregue sus propios datos para realizar pruebas.'
    },
    'goal-5': {
      title: 'Cerrar Contratos Empresariales',
      description: 'Cerrar 5 contratos empresariales con valor superior a $500K cada uno - Nota: Estos datos de demostración no se pueden editar. Por favor agregue sus propios datos para realizar pruebas.'
    }
  },
  demoReviews: {
    'review-1': {
  ...
  demoApplicants: {
    ...
    'app-2': {
      firstName: 'Jane',
      lastName: 'Smith',
      education: 'Maestría en Diseño',
      currentPosition: 'Líder de UX'
    }
  },
  demoApplications: {
    'appl-1': {
  ...
  translationStudio: {
    ...
    confirmTranslateAll: '¿Reemplazar todas las traducciones existentes de este texto con la salida automática? No se guarda nada hasta que pulses Guardar.',
    sourceCountHint: 'Registros totalmente traducidos / total',
    resizePanel: 'Cambiar el tamaño del panel de fuentes',
    accessDenied: 'Acceso denegado: se requieren privilegios de administrador',
    downloading: 'Descargando modelo de idioma',
    suggestAll: 'Sugerir campos vacíos',
    suggestHint: 'Solo rellena los campos vacíos. No se guarda nada hasta que lo revises.',
    suggested: 'Sugerencias insertadas',
    needsDownload: 'Sugerir en este idioma descarga primero un modelo',
    notConfigured: 'Falta la tabla de traducciones. Aplica la migración 018_hr_ugc_translations.sql (supabase db push) para habilitar el guardado.',
    title: 'Estudio de traducción',
    subtitle: 'Traducciones escritas a mano para tareas, objetivos, evaluaciones y solicitudes de permiso. Tienen prioridad sobre las automáticas en toda la aplicación.',
    sources: 'Fuentes',
    fields: 'Campos',
    sourceTasks: 'Tareas',
    sourceGoals: 'Objetivos personales',
    sourceReviews: 'Evaluaciones de desempeño',
    sourceLeave: 'Solicitudes de permiso',
    status: 'Estado',
    filter_all: 'Todo',
    filter_untranslated: 'Sin traducir',
    filter_translated: 'Completo',
    filter_stale: 'Desactualizado',
    searchPlaceholder: 'Buscar texto, registro o empleado',
    empty: 'Nada coincide con estos filtros.',
    loadError: 'No se pudo cargar el contenido traducible.',
    selectPrompt: 'Elige un texto a la izquierda para traducirlo.',
    saved: 'Guardado',
    removed: 'Eliminado',
    saveError: 'No se pudo guardar',
    stale: 'origen modificado',
    machineDraft: 'Borrador automático',
    remove: 'Eliminar',
    draftUnavailable: 'Todavía no hay modelo local para este idioma.',
    noLocalModel: 'Este navegador no tiene traductor local, por lo que los borradores automáticos no están disponibles. Aún puedes escribir las traducciones a mano.',
    demoUnavailable: 'Las traducciones se guardan en el servidor y no están disponibles en modo demostración.',
    field_title: 'Título',
    field_description: 'Descripción',
    field_self_assessment: 'Autoevaluación',
    field_comments: 'Comentarios',
    field_notes: 'Notas',
    field_success_criteria: 'Criterios de éxito',
    field_strengths: 'Fortalezas',
    field_areas_for_improvement: 'Áreas de mejora',
    field_achievements: 'Logros',
    field_employee_comments: 'Comentarios del empleado',
    field_reason: 'Motivo',
    field_rejection_reason: 'Motivo del rechazo',
  },
};
