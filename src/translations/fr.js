export default {
  ...
  nav: {
    ...
    settings: 'Paramètres',
    translations: 'Studio de traduction',
  ...
  leave: {
    ...
    requestsTitle: 'Demandes de congé',
    ...
    selectDatesFirst: "Cliquez d'abord sur une date de début et de fin dans le calendrier.",
    selectedDates: 'Dates sélectionnées',
    adjustOnCalendar: 'Fermez cette boîte de dialogue pour resélectionner les dates dans le calendrier.',
    ...
    halfDayTag: '[Demi-journée]',
    startTime: 'Heure de début',
    endTime: 'Heure de fin',
    reason: 'Motif',
    reasonPlaceholder: 'Ajoutez une note facultative pour votre responsable...',
    submitRequest: 'Soumettre la demande',
    requestSubmitted: 'Demande de congé soumise avec succès !',
    requestApproved: 'Demande de congé approuvée.',
    requestRejected: 'Demande de congé refusée.',
    rejectReasonPrompt: 'Motif du refus de cette demande (facultatif) :',
    approve: 'Approuver',
    reject: 'Refuser',
    other: 'Autre',
    ...
    filtersTitle: 'Filtres et légende',
    statusFilter: 'Statut',
    allStatuses: 'Tous',
    legendTitle: 'Légende',
    addForEmployee: 'Ajouter pour un employé',
    addLeaveForEmployee: 'Ajouter un congé pour un employé',
    autoApprove: 'Approuver immédiatement',
    autoApproveHint: 'Ignorer la file d\'attente et marquer comme approuvé.',
    submitAndApprove: 'Soumettre et approuver',
    submitAndApproved: 'Congé ajouté et approuvé.',
    manualDates: 'Saisissez les dates de début et de fin.',
    onBehalfNote: 'Vous soumettez un congé au nom de cet employé.',
  ...
  reports: {
    ...
    excel: {
      ...
      summaryTitle: 'Résumé du rapport RH',
      generated: 'Généré le',
      dateRange: 'Plage de dates',
      employee: 'Employé',
      reportLanguage: 'Langue du rapport',
      visual: 'Visuel',
      timeTracking: 'Résumé du suivi du temps',
      workload: 'Résumé de la charge de travail',
      goals: 'Résumé des objectifs',
      metrics: {
        totalTimeEntries: 'Nombre total d\'entrées de temps',
        totalHours: 'Total des heures enregistrées',
        regularHours: 'Heures régulières',
        overtimeHours: 'Heures supplémentaires',
        wfhHours: 'Heures en télétravail',
        pendingApprovals: 'Approbations en attente',
        approvedEntries: 'Entrées approuvées',
        totalTasks: 'Nombre total de tâches',
        completedTasks: 'Tâches terminées',
        inProgress: 'En cours',
        highPriorityTasks: 'Tâches à haute priorité',
        estimatedHours: 'Jours estimés',
        actualHours: 'Jours réels',
        variance: 'Écart',
        totalGoals: 'Nombre total d\'objectifs',
      ...
      performance: {
        ...
        taskCompletionRate: 'Taux d\'accomplissement des tâches',
        avgGoalProgress: 'Progrès moyen des objectifs',
        overallRating: 'Évaluation globale de la performance',
        overallScore: 'Score global de performance :',
        ratingLabel: 'Note :'
      },
      status: {
        high: 'Élevé',
  ...
  employeeDetailModal: {
    ...
    documents: 'Documents',
    pdfTab: 'PDF',
    requestDocsTab: 'Demandes',
    requestDocsRefresh: 'Actualiser',
    requestDocsOpen: 'Ouvrir',
    requestDocsPreview: 'Aperçu',
    requestDocsDelete: 'Supprimer',
    requestDocsOpenInNewTab: 'Ouvrir dans un nouvel onglet',
    requestDocsClosePreview: 'Fermer l\'aperçu',
    requestDocsLoading: 'Chargement...',
    uploadRequestDoc: 'Téléverser un document',
    docCategory: 'Catégorie',
    categoryLeave: 'Demande de congé',
    categoryOther: 'Autre',
    noRequestDocs: 'Aucun document téléversé',
    requestDocsHint: 'Téléversez des justificatifs de congé, certificats ou autres pièces.',
    requestDocsRestricted: 'Seuls Admin/RH/Manager peuvent téléverser des documents.',
    requestDocUploaded: 'Document téléversé avec succès!',
    quickStats: 'Statistiques Rapides',
    status: 'Statut',
  ...
  taskListing: {
    ...
    dueDate: 'Date d\'échéance',
    startDate: 'Date de début',
    completionBeforeStart: 'La date de fin ne peut pas précéder la date de début',
  ...
  translationStudio: {
    ...
    suggestHint: 'Ne remplit que les champs vides. Rien n\'est enregistré avant votre relecture.',
    suggested: 'Suggestions insérées',
    needsDownload: 'Suggérer dans cette langue télécharge d\'abord un modèle',
    notConfigured: 'La table des traductions est absente. Appliquez la migration 018_hr_ugc_translations.sql (supabase db push) pour activer l\'enregistrement.',
    ...
    sourceLeave: 'Demandes de congé',
    status: 'Statut',
    filter_all: 'Tout',
    filter_untranslated: 'Non traduit',
    filter_translated: 'Complet',
    filter_stale: 'Obsolète',
    searchPlaceholder: 'Rechercher un texte, un enregistrement ou un employé',
    empty: 'Aucun résultat pour ces filtres.',
    loadError: 'Impossible de charger le contenu traduisible.',
    selectPrompt: 'Choisissez un texte à gauche pour le traduire.',
    saved: 'Enregistré',
    removed: 'Supprimé',
    saveError: 'Enregistrement impossible',
    stale: 'source modifiée',
    machineDraft: 'Brouillon automatique',
    remove: 'Supprimer',
    draftUnavailable: 'Aucun modèle local n\'est encore disponible pour cette langue.',
    noLocalModel: 'Ce navigateur ne dispose pas de traducteur local ; les brouillons automatiques sont indisponibles. Vous pouvez toujours écrire les traductions à la main.',
    demoUnavailable: 'Les traductions sont stockées sur le serveur et ne sont pas disponibles en mode démo.',
    field_title: 'Titre',
    field_description: 'Description',
    field_self_assessment: 'Auto-évaluation',
    field_comments: 'Commentaires',
    field_notes: 'Notes',
    field_success_criteria: 'Critères de réussite',
    field_strengths: 'Points forts',
    field_areas_for_improvement: 'Axes d\'amélioration',
    field_achievements: 'Réalisations',
    field_employee_comments: 'Commentaires de l\'employé',
    field_reason: 'Motif',
    field_rejection_reason: 'Motif du refus',
  },
};
