export default {
  ...
  leave: {
    ...
    selectionRange: '선택됨',
    selectDatesFirst: '먼저 캘린더에서 시작일과 종료일을 클릭하세요.',
    selectedDates: '선택한 날짜',
    adjustOnCalendar: '이 대화 상자를 닫고 캘린더에서 날짜를 다시 선택하세요.',
    invalidRange: '종료일은 시작일보다 빠를 수 없습니다.',
    ...
    endTime: '종료 시간',
    reason: '사유',
    reasonPlaceholder: '관리자를 위한 메모를 선택적으로 추가하세요...',
    submitRequest: '신청 제출',
    requestSubmitted: '휴가 신청이 성공적으로 제출되었습니다!',
    requestApproved: '휴가 신청이 승인되었습니다.',
    requestRejected: '휴가 신청이 거부되었습니다.',
    rejectReasonPrompt: '이 신청을 거부하는 사유(선택 사항):',
    approve: '승인',
    reject: '거부',
    other: '기타',
    totalRequests: '전체 신청',
    ...
    filtersTitle: '필터 및 범례',
    statusFilter: '상태',
    allStatuses: '전체',
    legendTitle: '범례',
    addForEmployee: '직원 대신 추가',
    addLeaveForEmployee: '직원 휴가 추가',
    autoApprove: '즉시 승인',
    autoApproveHint: '대기열을 건너뛰고 승인됨으로 표시합니다.',
    submitAndApprove: '제출 및 승인',
    submitAndApproved: '휴가가 추가되고 승인되었습니다.',
    manualDates: '시작일과 종료일을 입력하세요.',
    onBehalfNote: '이 직원을 대신하여 휴가를 제출하고 있습니다.',
    rejectTitle: '휴가 신청 거부',
  ...
  employeeDetailModal: {
    ...
    pdfTab: 'PDF',
    requestDocsTab: '요청',
    requestDocsRefresh: '새로고침',
    requestDocsOpen: '열기',
    requestDocsPreview: '미리보기',
    requestDocsDelete: '삭제',
    requestDocsOpenInNewTab: '새 탭에서 열기',
    requestDocsClosePreview: '미리보기 닫기',
    requestDocsLoading: '로딩 중...',
    uploadRequestDoc: '문서 업로드',
    docCategory: '카테고리',
    categoryLeave: '휴가 요청',
    categoryOther: '기타',
    noRequestDocs: '업로드된 문서가 없습니다',
    requestDocsHint: '휴가 증빙, 자격증 등 지원 문서를 업로드하세요.',
    requestDocsRestricted: 'Admin/HR/Manager만 업로드할 수 있습니다.',
    requestDocUploaded: '문서가 업로드되었습니다!',
    quickStats: '빠른 통계',
    status: '상태',
    workDuration: '근무 기간',
    workDurationNA: 'N/A',
  ...
  taskListing: {
    ...
    dueDate: '마감일',
    startDate: '시작일',
    completionBeforeStart: '완료일은 시작일보다 이전일 수 없습니다',
    manageTasks: '작업 관리',
    organization: '조직',
    assignTo: '할당 대상',
    taskList: '작업 목록',
  ...
  translationStudio: {
    ...
    suggestHint: '빈 칸만 채웁니다. 검토 후 저장하기 전까지 아무것도 저장되지 않습니다.',
    suggested: '제안이 입력되었습니다',
    needsDownload: '이 언어를 제안하려면 먼저 모델을 다운로드합니다',
    notConfigured: '번역 테이블이 없습니다. 저장을 활성화하려면 마이그레이션 018_hr_ugc_translations.sql을 적용하세요 (supabase db push).',
    title: '번역 스튜디오',
    ...
    status: '상태',
    filter_all: '전체',
    filter_untranslated: '미번역',
    filter_translated: '완료',
    filter_stale: '원문 변경됨',
    searchPlaceholder: '텍스트, 레코드 또는 직원 검색',
    empty: '조건에 맞는 항목이 없습니다.',
    loadError: '번역 가능한 콘텐츠를 불러오지 못했습니다.',
    selectPrompt: '왼쪽에서 번역할 문장을 선택하세요.',
    saved: '저장됨',
    removed: '삭제됨',
    ...
    machineDraft: '자동 초안',
    remove: '삭제',
    draftUnavailable: '이 언어의 온디바이스 모델이 아직 없습니다.',
    noLocalModel: '이 브라우저에는 온디바이스 번역기가 없어 자동 초안을 사용할 수 없습니다. 직접 번역을 작성할 수는 있습니다.',
    demoUnavailable: '번역은 서버에 저장되므로 데모 모드에서는 사용할 수 없습니다.',
    field_title: '제목',
    field_description: '설명',
    field_self_assessment: '자기 평가',
    field_comments: '의견',
    field_notes: '메모',
    field_success_criteria: '성공 기준',
    field_strengths: '강점',
    field_areas_for_improvement: '개선 영역',
    field_achievements: '성과',
    field_employee_comments: '직원 의견',
    field_reason: '사유',
    field_rejection_reason: '거절 사유',
  },
};
