export default {
  ...
  help: {
    ...
    demo: {
      ...
      body: 'ДАННЫЕ НЕ СОХРАНЯЮТСЯ. Все созданные записи, изменения и удаления будут потеряны при обновлении страницы или закрытии браузера. Функции пакетного редактирования и экспорта CSV отключены в этой среде.'
    },
