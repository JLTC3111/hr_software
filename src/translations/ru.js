export default {
  ...
  leave: {
    ...
    noRequests: 'Заявок на отпуск пока нет.',
    everyone: 'Все',
    mine: 'Мои отпуска',
    today: 'Сегодня',
    clearSelection: 'Очистить выбор',
    cmdClickHint: '{mod} или Shift+щелчок по другому дню, чтобы добавить его, или по выбранному дню, чтобы пропустить его.',
    selectStartHint: 'Совет: щёлкните день, чтобы начать заявку на отпуск, затем щёлкните последний день.',
    selectEndHint: 'Теперь щёлкните дату окончания (или тот же день для одного дня).',
    selectionRange: 'Выбрано',
    selectDatesFirst: 'Сначала выберите дату начала и окончания в календаре.',
    selectedDates: 'Выбранные даты',
    adjustOnCalendar: 'Закройте это окно, чтобы заново выбрать даты в календаре.',
    invalidRange: 'Дата окончания не может быть раньше даты начала.',
    selectEmployee: 'Пожалуйста, выберите сотрудника.',
    type: 'Тип',
    allTypes: 'Все типы',
    employee: 'Сотрудник',
    ...
    reason: 'Причина',
    reasonPlaceholder: 'Добавьте необязательную заметку для руководителя...',
    submitRequest: 'Отправить заявку',
    requestSubmitted: 'Заявка на отпуск успешно отправлена!',
    requestApproved: 'Заявка на отпуск одобрена.',
    requestRejected: 'Заявка на отпуск отклонена.',
    rejectReasonPrompt: 'Причина отклонения этой заявки (необязательно):',
    approve: 'Одобрить',
    reject: 'Отклонить',
    other: 'Другое',
    ...
    filtersTitle: 'Фильтры и легенда',
    statusFilter: 'Статус',
    allStatuses: 'Все',
    legendTitle: 'Легенда',
    addForEmployee: 'Добавить для сотрудника',
    addLeaveForEmployee: 'Добавить отпуск для сотрудника',
    autoApprove: 'Одобрить сразу',
    autoApproveHint: 'Пропустить очередь и отметить как одобренный.',
    submitAndApprove: 'Отправить и одобрить',
    submitAndApproved: 'Отпуск добавлен и одобрен.',
    manualDates: 'Введите даты начала и окончания.',
    onBehalfNote: 'Вы подаёте отпуск от имени этого сотрудника.',
    rejectTitle: 'Отклонить заявку на отпуск',
  ...
  header: {
    ...
    welcomePhrase1: 'С возвращением, {name}',
    welcomePhrase2: 'Рад вас видеть, {name}',
    welcomePhrase3: 'Здравствуйте, {name}!',
    welcomePhrase4: 'Готовы управлять HR, {name}?',
  ...
  login: {
    ...
    forgotPasswordModal: {
      ...
      emailRateLimitError: 'Достигнут лимит отправки писем. Повторите попытку позже.',
  ...
  reports: {
    ...
    excel: {
      ...
      summaryTitle: 'Сводка HR-отчета',
      generated: 'Сформировано',
      dateRange: 'Период',
      employee: 'Сотрудник',
      reportLanguage: 'Язык отчета',
      visual: 'Визуализация',
      timeTracking: 'Сводка учета времени',
      workload: 'Сводка рабочей нагрузки',
      goals: 'Сводка по целям',
      metrics: {
        totalTimeEntries: 'Всего записей времени',
        totalHours: 'Всего отработано часов',
        regularHours: 'Обычные часы',
        overtimeHours: 'Сверхурочные',
        wfhHours: 'Удаленная работа',
        pendingApprovals: 'Ожидают одобрения',
        approvedEntries: 'Одобренные записи',
        totalTasks: 'Всего задач',
        completedTasks: 'Выполнено задач',
        inProgress: 'В процессе',
        highPriorityTasks: 'Высокоприоритетные задачи',
        estimatedHours: 'Оценочные дни',
        actualHours: 'Фактические дни',
        variance: 'Отклонение',
        totalGoals: 'Всего целей',
        completedGoals: 'Выполнено целей',
        avgProgress: 'Средний прогресс'
      },
      performance: {
        header: 'Отчет об эффективности',
        ...
        taskCompletionRate: 'Доля выполненных задач',
        avgGoalProgress: 'Средний прогресс по целям',
        overallRating: 'Общий рейтинг эффективности',
        overallScore: 'Общий балл эффективности:',
        ratingLabel: 'Рейтинг:'
      },
      status: {
        high: 'Высокий',
      ...
      headers: {
        ...
        position: 'Должность',
        date: 'Дата',
        clockIn: 'Начало смены',
        clockOut: 'Конец смены',
        hourType: 'Тип часов',
        notes: 'Заметки',
        createdAt: 'Создано',
  ...
  employeeDetailModal: {
    ...
    documents: 'Документы',
    pdfTab: 'PDF',
    requestDocsTab: 'Заявки',
    requestDocsRefresh: 'Обновить',
    requestDocsOpen: 'Открыть',
    requestDocsPreview: 'Просмотр',
    requestDocsDelete: 'Удалить',
    requestDocsOpenInNewTab: 'Открыть в новой вкладке',
    requestDocsClosePreview: 'Закрыть просмотр',
    requestDocsLoading: 'Загрузка...',
    uploadRequestDoc: 'Загрузить документ',
    docCategory: 'Категория',
    categoryLeave: 'Заявка на отпуск',
    categoryOther: 'Другое',
    noRequestDocs: 'Документы не загружены',
    requestDocsHint: 'Загрузите подтверждения для отпуска, сертификаты или другие файлы.',
    requestDocsRestricted: 'Только Admin/HR/Manager могут загружать документы.',
    requestDocUploaded: 'Документ успешно загружен!',
    quickStats: 'Быстрая Статистика',
    status: 'Статус',
  ...
  settings: {
    ...
    desktopDenied: 'Уведомления для {origin} заблокированы. В адресной строке разрешите уведомления, затем включите параметр снова.',
    desktopEmbedded: 'Это окно не может показывать уведомления на рабочем столе. Откройте {origin} в Chrome или Safari и разрешите уведомления.',
    desktopInsecure: 'Для уведомлений на рабочем столе нужны http://localhost или https. Эта страница — {origin}.',
    desktopUnsupported: 'Этот браузер не может показывать уведомления на рабочем столе.',
    desktopTestTitle: 'Уведомления на рабочем столе включены',
    desktopTestBody: 'При новых уведомлениях будут появляться такие оповещения.',
    desktopPermissionRequired: 'Разрешение на уведомления для {origin} не предоставлено. Разрешите их в настройках сайта этого браузера и повторите попытку.',
  ...
  taskListing: {
    ...
    dueDate: 'Срок',
    startDate: 'Дата начала',
    completionBeforeStart: 'Дата завершения не может быть раньше даты начала',
  ...
  controlPanel: {
    ...
    role: 'Роль',
    switchToPrefix: 'Переключиться на',
    demoAdminLabel: 'Демонстрационный администратор',
    demoEmployeeLabel: 'Демонстрационный сотрудник',
  ...
  help: {
    ...
    features: {
      ...
      feature_1: {
        ...
        description: 'Вы можете редактировать до 50 записей одновременно. Выберите флажки рядом с элементами и нажмите значок редактирования вверху таблицы. Эта функция отключена в текущей демонстрации.'
      },
      feature_2: {
  ...
  translationStudio: {
    ...
    confirmTranslateAll: 'Заменить все существующие переводы этого текста машинным выводом? Ничего не сохраняется, пока вы не нажмёте «Сохранить».',
    sourceCountHint: 'Полностью переведённые записи / всего записей',
    resizePanel: 'Изменить размер панели источников',
    accessDenied: 'Доступ запрещён: требуются права администратора',
    downloading: 'Загрузка языковой модели',
    suggestAll: 'Предложить для пустых полей',
    suggestHint: 'Заполняет только пустые поля. Ничего не сохраняется, пока вы не проверите.',
    suggested: 'Предложения подставлены',
    needsDownload: 'Предложение на этом языке сначала загрузит модель',
    notConfigured: 'Таблица переводов отсутствует. Примените миграцию 018_hr_ugc_translations.sql (supabase db push), чтобы включить сохранение.',
    title: 'Студия переводов',
    subtitle: 'Переводы, написанные вручную, для задач, целей, аттестаций и заявок на отпуск. Они имеют приоритет над автоматическими во всём приложении.',
    sources: 'Источники',
    fields: 'Поля',
    sourceTasks: 'Задачи',
    sourceGoals: 'Личные цели',
    sourceReviews: 'Оценка работы',
    sourceLeave: 'Заявки на отпуск',
    status: 'Статус',
    filter_all: 'Все',
    filter_untranslated: 'Без перевода',
    filter_translated: 'Готово',
    filter_stale: 'Устарело',
    searchPlaceholder: 'Поиск по тексту, записи или сотруднику',
    empty: 'Ничего не найдено по этим фильтрам.',
    loadError: 'Не удалось загрузить переводимое содержимое.',
    selectPrompt: 'Выберите текст слева, чтобы перевести его.',
    saved: 'Сохранено',
    removed: 'Удалено',
    saveError: 'Не удалось сохранить',
    stale: 'исходник изменён',
    machineDraft: 'Машинный черновик',
    remove: 'Удалить',
    draftUnavailable: 'Для этого языка ещё нет локальной модели.',
    noLocalModel: 'В этом браузере нет локального переводчика, поэтому машинные черновики недоступны. Переводы можно писать вручную.',
    demoUnavailable: 'Переводы хранятся на сервере и недоступны в демонстрационном режиме.',
    field_title: 'Заголовок',
    field_description: 'Описание',
    field_self_assessment: 'Самооценка',
    field_comments: 'Комментарии',
    field_notes: 'Заметки',
    field_success_criteria: 'Критерии успеха',
    field_strengths: 'Сильные стороны',
    field_areas_for_improvement: 'Зоны роста',
    field_achievements: 'Достижения',
    field_employee_comments: 'Комментарии сотрудника',
    field_reason: 'Причина',
    field_rejection_reason: 'Причина отказа',
  },
};
