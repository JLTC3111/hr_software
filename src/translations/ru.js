export default {
  ...
  demoTasks: {
    'task-1': { title: 'Анализ Отчётов Q4', description: 'Комплексный анализ квартальных показателей эффективности и тенденций' },
    'task-2': { title: 'Обновление Справочника Сотрудника', description: 'Пересмотр и обновление справочника сотрудника с политиками удалённой работы' },
    'task-3': { title: 'Исправление Ошибки Входа', description: 'Отладка и решение проблем входа пользователей на мобильных устройствах' },
    'task-4': { title: 'Дизайн Новой Панели', description: 'Создание макетов и прототипов для аналитической панели управления' },
    'task-5': { title: 'Анализ Эффективности Кампании', description: 'Анализ результатов и ROI маркетинговых кампаний Q3' },
    'task-6': { title: 'Подключение Клиента', description: 'Завершить процесс подключения нового корпоративного клиента' },
    'task-7': { title: 'Документация API', description: 'Написать комплексную документацию API для версии 2.0' }
  },
  demoGoals: {
    ...
    'goal-3': { title: 'UX Сертификация', description: 'Получить профессиональный сертификат Google UX Design' },
    'goal-4': { title: 'Увеличить Генерацию Лидов', description: 'Достичь 30% увеличения квалифицированных лидов через маркетинговые кампании' },
    'goal-5': { title: 'Заключить Корпоративные Контракты', description: 'Заключить 5 корпоративных контрактов стоимостью более $500K каждый' }
  },
