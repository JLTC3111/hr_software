export default {
  ...
  demoTasks: {
    'task-1': { title: 'การวิเคราะห์รายงาน Q4', description: 'การวิเคราะห์ที่ครอบคลุมเกี่ยวกับตัวชี้วัดประสิทธิภาพรายไตรมาสและแนวโน้ม' },
    'task-2': { title: 'อัปเดตคู่มือพนักงาน', description: 'แก้ไขและอัปเดตคู่มือพนักงานด้วยนโยบายการทำงานทางไกล' },
    'task-3': { title: 'แก้ไขข้อผิดพลาดการเข้าสู่ระบบ', description: 'ดีบักและแก้ไขปัญหาการเข้าสู่ระบบของผู้ใช้บนอุปกรณ์มือถือ' },
    'task-4': { title: 'ออกแบบแดชบอร์ดใหม่', description: 'สร้าง wireframes และ mockups สำหรับแดชบอร์ดวิเคราะห์' },
    'task-5': { title: 'ตรวจสอบประสิทธิภาพแคมเปญ', description: 'วิเคราะห์ผลลัพธ์และ ROI ของแคมเปญการตลาด Q3' },
    'task-6': { title: 'การรับลูกค้าใหม่', description: 'ดำเนินการ onboarding สำหรับลูกค้าองค์กรรายใหม่ให้เสร็จสิ้น' },
    'task-7': { title: 'เอกสาร API', description: 'เขียนเอกสาร API ที่ครอบคลุมสำหรับเวอร์ชัน 2.0' }
  },
  demoGoals: {
    ...
    'goal-3': { title: 'ใบรับรอง UX', description: 'ได้รับใบรับรองวิชาชีพ Google UX Design' },
    'goal-4': { title: 'เพิ่มการสร้างลีด', description: 'บรรลุเป้าหมายเพิ่มลีดที่มีคุณสมบัติ 30% ผ่านแคมเปญการตลาด' },
    'goal-5': { title: 'ปิดดีลองค์กร', description: 'ปิดดีลองค์กร 5 รายการที่มีมูลค่ามากกว่า $500K ต่อราย' }
  },
